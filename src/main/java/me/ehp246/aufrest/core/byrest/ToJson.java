...
public interface ToJson {
    String apply(Object value, Descriptor valueInfo);

    default String apply(final Object value) {
        return this.apply(value, new Descriptor(value.getClass(), new Annotation[] {}));
    }
    ...
    public final class Descriptor {
        ...
        public Descriptor(final Class<?> type, final Annotation[] annotations) {
            this.type = type;
